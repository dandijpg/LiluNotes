...
// Fungsi untuk menambahkan kucing yang muncul secara acak
function spawnRandomCat() {
    const cat = document.createElement('div');
    cat.className = 'random-cat';
    cat.innerHTML = `
        <svg width="50" height="50" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <path d="M50 20c-10 0-15 10-15 15s5 15 15 15 15-10 15-15-5-15-15-15zm-8 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm16 0a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="#ff9999"/>
        </svg>
    `;
...
// Tambahkan kucing saat klik tombol
