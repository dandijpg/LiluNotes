...
function setupEventListeners() {
 ...
 document.getElementById('tabBtn').addEventListener('click', insertTab); // Tombol tab baru
 ...
 // Tangkap pintasan keyboard untuk tab
...
function insertTab() {
 ...
 const range = saveCursorPosition(noteContent);
 if (range) {
 const tabNode = document.createTextNode('\u00A0\u00A0\u00A0\u00A0'); // 4 spasi sebagai tab
