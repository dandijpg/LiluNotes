...
function insertTable() {
 ...
 restoreCursorPosition(range);
 toggleTableButtons(); // Pastikan tombol muncul setelah tabel disisipkan
}
...
function handleTableClick(event) {
 ...
 const regularTable = event.target.closest('.regular-table');
 const allWrappers = noteContent.querySelectorAll('.finance-table-wrapper');

 // Sembunyikan tombol finansial untuk semua tabel finansial
 ...
 if (wrapper) {
 // Jika klik pada tabel finansial, tampilkan tombol finansial
 ...
 // Jika klik pada tabel reguler, aktifkan tombol tabel reguler
 toggleTableButtons();
 } else {
 // Jika klik di luar tabel, sembunyikan tombol tabel reguler
 document.getElementById('addRowBtn').style.display = 'none';
 document.getElementById('addColBtn').style.display = 'none';
 document.getElementById('deleteRowBtn').style.display = 'none';
 document.getElementById('deleteColBtn').style.display = 'none';
 }
}
...
function updateFinancialTable(event) {
 ...
 calculateTotal(table.parent Element);
 }
 });
 });
}
...
function addRow() {
 ...
 toggleTableButtons(); // Perbarui tombol setelah baris ditambahkan
 }
}
...
function addColumn() {
 ...
 toggleTableButtons(); // Perbarui tombol setelah kolom ditambahkan
 }
}
...
function deleteRow() {
 ...
 toggleTableButtons(); // Perbarui tombol setelah baris dihapus
 }
 }
}
...
function deleteColumn() {
 ...
 toggleTableButtons(); // Perbarui tombol setelah kolom dihapus
 }
 }
}
...
function toggleTableButtons() {
 ...
 deleteRowBtn.style.display = table.rows.length > 1 ? 'inline-block' : 'none';
 deleteColBtn.style.display = table.rows[0].cells.length > 1 ? 'inline-block' : 'none';
 } else {
